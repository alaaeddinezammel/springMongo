...
public class JobConfiguration {
	...
	@Bean
	public ItemWriter<logLine> LogItemWriter() {
		return items ->{
			for(logLine item:items) {
...
/*	  @Bean
	  public MongoItemWriter<logLine> LogItemWriter() {
	    MongoItemWriter<logLine> writer = new MongoItemWriter<>();
	...
	public Step step1() {
		return stepBuilderFactory.get("step1")
				.<String, logLine>chunk(10)
				.reader(CusItemReader())
				.processor(itemProcessorr())
